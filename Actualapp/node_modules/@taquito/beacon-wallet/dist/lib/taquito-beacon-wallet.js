            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _b = [params];
                        return [4 /*yield*/, taquito_1.createTransferOperation(this.formatParameters(params))];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this.removeDefaultParams;
                        _b = [params];
                        return [4 /*yield*/, taquito_1.createOriginationOperation(this.formatParameters(params))];
                    case 1: return [2 /*return*/, _a.apply(this, _b.concat([_c.sent()]))];
                }
            });
        });
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this.removeDefaultParams;
                        _b = [params];
                        return [4 /*yield*/, taquito_1.createSetDelegateOperation(this.formatParameters(params))];
                    case 1: return [2 /*return*/, _a.apply(this, _b.concat([_c.sent()]))];
                }
            });
        });
